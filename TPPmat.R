...
makemat <- function(setup, pars)
{
  ...
  for (jh in 1:2)
  {
    ...
    # some transition to failure as opposed to initial treatment response: 
    ...
    acqresmat <- array(0,dim=c(8,8,3)); dimnames(acqresmat)=list(Rnames, Rnames, regimens) # from old resistance (down) to new resistance (across), by regimen 
...
dxdt <- function(setup, pars, tally,...)
{
  # infection
  # superinfection
