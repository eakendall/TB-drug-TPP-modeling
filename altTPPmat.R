...
set.novelvalues <- function(SAf=FALSE, iHIV=FALSE)
{
  selections <- list()
  ...
  if(SAf) selections$eligibility <- array(c(1,0.82,  0.95,0.9,  1,1,
                                              1,0.82,  0.95,0.9,  1,1), dim=c(2,3,2)) else 
  if(iHIV) selections$eligibility <- array(c(0.93,0, 0.95,0.9,  1,1,
                                              0.93,0,  0.95,0.9,  1,1), dim=c(2,3,2)) else 
  ...
  selections$rifdx_increase <- c(0, 0, 1) # for DR only
