# Purpose is to provide allmin with HIV exclusions, for comparison with altattribfrac for allbut_exclusions_HIV i.e. for only the HIV-concentrated exclusions in an otherwise-optimized regimen.
